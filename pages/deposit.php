...
<div class="withdraw-container col-md-99 col-sm-8 site-area">
        <div class="col-lg-66 site-inventory">
            <div class="site-inv-content">
                ...
                <input class="force-reload" type="button" value="reload inventory">
                <div class="items inventory"></div>
            </div>
        </div>
        <div class="col-lg-67 withdraw">
            <div class="withdraw-header">Select items for Deposit</div>
            <div class="withdraw-content">
                ...
                <div class="deposit-item-button confirm-button">Deposit Items (<span class="deposit-value">0</span>)</div>
    ...
    <script src="assets/js/deposit.js?v=<?=time()?>"></script>
